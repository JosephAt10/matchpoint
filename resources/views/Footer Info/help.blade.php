...
<head>
    ...
    <title>{{ __('Help') }} - MatchPoint</title>
...
<body class="min-h-screen bg-[#E8E8F5] text-[#1a1f3a]">
    <main class="mx-auto max-w-3xl px-4 py-16">
        ...
        <section class="mt-6 rounded-3xl bg-white p-8 shadow-sm">
            <h1 class="text-3xl font-bold">{{ __('Help') }}</h1>
            <p class="mt-4 text-sm text-slate-600">{{ __('This page can hold user guidance and FAQs as the project grows.') }}</p>
        </section>
    </main>
</body>
</html>
